...
def fake_settings():
    return SimpleNamespace(
        ...
        JOBS_PROVIDER_MAX_CONCURRENCY=3,
        JOBS_MAX_RESPONSE_JOBS=160,
        JOBS_MAX_LIVE_AGGREGATE_JOBS=300,
        JOBS_CACHE_CLEANUP_INTERVAL_SECONDS=900,
    )
